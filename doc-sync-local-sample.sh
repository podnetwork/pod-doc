...
#   - <version> = version of document on pod doc site
#   - <content branch name> = branch name on markdown content repo pulled to local
...
sh ./doc-sync.sh "<version>:<content branch name>" "<local folder>"
